...
class GreenhouseAdapter:
    ...
    async def discover(
        ...
        try:
            ...
            return [
                self._normalize(job, source, fetched_at)
                for job in greenhouse_response.jobs
            ]
    ...
    def _normalize(
        ...
        return JobSnapshot(
            ...
            raw_posting=job.model_dump(mode="json"),
        )
